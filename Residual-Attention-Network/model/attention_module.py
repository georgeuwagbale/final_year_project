...
class AttentionModule_stage1_cifar(nn.Module):
    ...
    def forward(self, x):
        ...
        #
        # print("Shape of out_middle_2r_blocks:", out_middle_2r_blocks.shape)
        # print("Shape of out_down_residual_blocks1:", out_down_residual_blocks1.shape)
...
class AttentionModule_stage3_cifar(nn.Module):
    ...
    def get_out_conv1_1_blocks(self):
        return self.out_conv1_1_blocks
    ...
    def forward(self, x):
        ...
        self.out_conv1_1_blocks = out_conv1_1_blocks
        out = (1 + out_conv1_1_blocks) * out_trunk
        out_last = self.last_blocks(out)
